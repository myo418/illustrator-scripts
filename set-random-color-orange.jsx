...
for (var i = 0; i < pathItems.length; i++) {
  ...
  if (itemCenterY > centerY) {
    ...
    var changedHue = Math.random() > randomHueProb ? middleColor.hue : Math.random() * 360
    var hue = changedHue + (topColor.hue - changedHue) * ratio + Math.random() * randomHue - randomHue / 2;
    ...
    var changedHue = Math.random() > randomHueProb ? middleColor.hue : Math.random() * 360
    var hue = changedHue - (changedHue - bottomColor.hue) * ratio + Math.random() * randomHue - randomHue / 2;
